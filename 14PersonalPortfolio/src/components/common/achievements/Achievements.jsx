  ...
  return (
    <div className='text-secondary font-primary py-20'>
      ...
      <div className='flex flex-wrap justify-evenly'>{achievementData.content.map((data, index) => (
        <div className='w-4/5 sm:h-100 sm:w-80 flex flex-col items-center justify-evenly p-2 m-3 bg-tertiary rounded-xl duration-700 hover:cursor-pointer hover:scale-105' key={index}>
