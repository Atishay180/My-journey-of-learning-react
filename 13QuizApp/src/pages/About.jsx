...
const About = () => {
  return (
    <div className="bg-gray-100 min-h-screen p-8">
      ...
      <div className="max-w-8xl mx-auto bg-white p-8 rounded-lg shadow-lg fade-in">
        ...
        <div className="mb-6 p-6 bg-primary-light rounded-lg shadow-inner fade-in">
        ...
        <div className="p-6 bg-primary-light rounded-lg shadow-inner fade-in">
