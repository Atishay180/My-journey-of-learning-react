    ...
    <div className="bg-gray-100 min-h-screen p-8">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="p-6 bg-blue-50 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700">
            If you have any questions or feedback, feel free to reach out to us at <a href="mailto:info@quizapp.com" className="text-blue-700 underline">info@quizapp.com</a>. We would love to hear from you!
          </p>
        </div>
      </div>
    </div>
