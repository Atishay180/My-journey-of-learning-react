  ...
  return (
    <div className="bg-gray-100 min-h-screen p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold mb-6 text-center text-blue-700">Our Services</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h2 className="text-2xl font-semibold mt-4 mb-4 text-blue-700">Interactive Quizzes</h2>
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h2 className="text-2xl font-semibold mt-4 mb-4 text-blue-700">Custom Quiz Creation</h2>
            <p className="text-gray-700">
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h2 className="text-2xl font-semibold mt-4 mb-4 text-blue-700">Progress Tracking</h2>
            <p className="text-gray-700">
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h2 className="text-2xl font-semibold mt-4 mb-4 text-blue-700">Community Support</h2>
            <p className="text-gray-700">
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h2 className="text-2xl font-semibold mt-4 mb-4 text-blue-700">Certification</h2>
            <p className="text-gray-700">
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h2 className="text-2xl font-semibold mt-4 mb-4 text-blue-700">Live Quiz Events</h2>
            <p className="text-gray-700">
