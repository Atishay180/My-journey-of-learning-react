  ...
  return (
    <div className="bg-gray-100 min-h-screen p-8">
      ...
      <div className="max-w-6xl mx-auto">
        <h1 className="animate-text text-4xl font-bold mb-6 text-center text-primary-dark">Our Services</h1>
        <p className="animate-text mb-10 text-gray-700 text-center">
          Discover the range of services we offer to enhance your learning experience.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="fade-in p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
